  ...
  return (
    ...
    <div className="flex items-center h-screen md:flex justify-around max-w-screen m-auto " >
      <div className="flex flex-col text-center w-1/2 m-2 "  >
        ...
        <p className="text-tertiaryColor text-wrap text-center mt-4 p-4 text-md">Sempre em busca de novos conhecimentos. Sou Cristão, esposo, pai, amo tecnologia e também tocar uma guitarrinha!🎸</p>
